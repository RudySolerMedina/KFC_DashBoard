...
TOPIC_DEFINITIONS = [
    ...
    {'id': 'p_l3', 'label': 'Мощность L3', 'topic': 'Nevinnomisk/devices/energomera303_00000201/controls/P L3', 'unit': 'Вт', 'group': 'power'},
    ...
    {'id': 'indoor_sound', 'label': 'Уровень шума', 'topic': 'Nevinnomisk/devices/wb-msw-v4_41/controls/Sound Level', 'unit': 'дБ', 'group': 'microclimate'},
